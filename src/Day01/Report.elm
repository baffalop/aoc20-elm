...
repair : String -> Maybe ( Int, Int )
repair =
    parseInput
        >> findPairsSummingTo 2020 Set.empty


repairThrees : String -> Maybe ( Int, Int, Int )
repairThrees =
    parseInput
        >> findThreesSummingTo 2020 []
        ...
        x :: xs ->
            let
                complement =
                    sum - x
            in
            case findPairsSummingTo complement Set.empty (seen ++ xs) of
                Nothing ->
